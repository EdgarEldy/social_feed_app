...
/// The signed-in or newly registered user.
 User get user;/// Short-lived JWT sent as `Authorization: Bearer <token>` on every
/// authenticated request.
 String get accessToken;/// Longer-lived token exchanged for a new access token via
/// `POST /auth/refresh`.
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthSession&&(identical(other.user, _this.user) || other.user == _this.user)&&(identical(other.accessToken, _this.accessToken) || other.accessToken == _this.accessToken)&&(identical(other.refreshToken, _this.refreshToken) || other.refreshToken == _this.refreshToken));
}
...
String toString() {
  final _this = this as AuthSession;
  return 'AuthSession(user: ${_this.user}, accessToken: ${_this.accessToken}, refreshToken: ${_this.refreshToken})';
}
