...
/// Server-assigned unique identifier.
 String get id;/// Id of the `User` who authored the post.
 String get authorId;/// The author's display name at the time the post was fetched,
/// denormalized so the feed can render an author byline without a
/// separate `User` call.
 String get authorName;/// The author's avatar URL, denormalized for the same reason as
/// `authorName`. `null` if the author has no avatar set.
 String? get authorPhotoUrl; String get title; String get content;/// URL of the post's attached image, or `null` for a text-only post.
 String? get imageUrl; DateTime get createdAt;/// When the post was last edited via `PATCH /posts/:id`, or `null` if
/// it has never been edited.
 DateTime? get updatedAt; int get commentsCount; int get likesCount;/// Whether the currently signed-in user has liked this post.
///
...
class _Post implements Post {
  const _Post({required this.id, required this.authorId, required this.authorName, this.authorPhotoUrl, required this.title, required this.content, this.imageUrl, required this.createdAt, this.updatedAt, required this.commentsCount, required this.likesCount, required this.isLikedByMe});
...
@override
String toString() {
    return 'Post(id: $id, authorId: $authorId, authorName: $authorName, authorPhotoUrl: $authorPhotoUrl, title: $title, content: $content, imageUrl: $imageUrl, createdAt: $createdAt, updatedAt: $updatedAt, commentsCount: $commentsCount, likesCount: $likesCount, isLikedByMe: $isLikedByMe)';
}
