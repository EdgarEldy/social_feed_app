...
void main() {
  // Dio and GoRouter are registered directly instead of going through
  // configureDependencies(), because DioClient.create() reads
  // dotenv.env['API_BASE_URL'], which throws unless dotenv.load() has
  // already run against a real .env file. That file loading is unrelated
  // to what this widget test is checking, so a plain Dio() stands in for it.
  setUp(() {
